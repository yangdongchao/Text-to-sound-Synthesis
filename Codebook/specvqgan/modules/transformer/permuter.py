...
class Identity(AbstractPermuter): # Nothing changed
    def __init__(self):
        super().__init__()
...
class ColumnMajor(AbstractPermuter):
    ...
    def __init__(self, H, W):
        ...
        self.register_buffer('backward_shuffle_idx', torch.argsort(idx)) # 返回排序的索引
    ...
    def make_idx(self, H, W):
        ...
        idx = idx.T
        idx = torch.tensor(idx.ravel()) # 拉成一维数组
        return idx
