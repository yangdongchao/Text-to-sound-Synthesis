...
from specvqgan.modules.losses.lpaps_audioset import LPLoss
...
class VQLPAPSWithDiscriminator_without_per(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        self.perceptual_loss = LPLoss().eval() # using pretraining model to extract feature
        ...
        if disc_loss == "hinge": # the type of discriminator
...
class VQLPAPSWithDiscriminator_audioset(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 disc_num_layers=3, disc_in_channels=3, disc_factor=1.0, disc_weight=1.0,
...
class VQLPAPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        self.codebook_weight = codebook_weight
        self.pixel_weight = pixelloss_weight
        self.perceptual_loss = LPAPS().eval() # using pretraining model to extract feature
        self.perceptual_weight = perceptual_weight
