...
def train_inception_scorer(cfg):
    ...
    train_ids_path = '/apdcephfs/share_1316500/donchaoyang/code3/SpecVQGAN/specvqgan/modules/losses/vggishish/data/audioset_train.txt'
...
if __name__ == '__main__':
    ...
    cfg_yml = OmegaConf.load('/apdcephfs/share_1316500/donchaoyang/code3/SpecVQGAN/specvqgan/modules/losses/vggishish/configs/melception.yaml')
    # the latter arguments are prioritized
    cfg = cfg_yml
    OmegaConf.set_readonly(cfg, True)
    # print(OmegaConf.to_yaml(cfg))
